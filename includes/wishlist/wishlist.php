...
add_action( 'wp_ajax_tm_woowislist_count', 'tm_woowislist_count_ajax' );
add_action( 'wp_ajax_nopriv_tm_woowislist_count', 'tm_woowislist_count_ajax' );
...
function tm_woowislist_count_ajax(){
	$wishlist_count = 0;
